...
export default class Choropleth {
  ...
  scaffold() {
    ...
    this.canvasCountiesHidden = this.container
      ...
      .attr("height", this.height * this.dpr)
      .style("display", "none");
    this.ctxHidden = this.canvasCountiesHidden
      .node()
    ...
    this.svgActive = this.container
      ...
      .attr("viewBox", [0, 0, this.width, this.height]);
    this.activeG = this.svgActive.append("g");
    this.activePath = this.activeG.append("path").attr("class", "active-path");
    ...
    this.resetButton = this.container
      ...
      .call((button) =>
        button
          .append("svg")
          .attr("class", "reset-button__icon")
          .append("svg")
          .attr("viewBox", [0, 0, 24, 24])
          .append("path")
          .attr("fill", "currentColor")
          .attr("d", "m14 18l-6-6l6-6l1.4 1.4l-4.6 4.6l4.6 4.6z")
      )
      .call((button) =>
        button
          .append("span")
          .attr("class", "reset-button__label")
          .text("Go Back")
      )
    ...
    this.tooltipCountyName = this.tooltipContainer
      .append("div")
  ...
  zoomed({ transform }) {
    ...
    this.activeG.attr("transform", this.transform);
    this.renderCounties();
  }
  ...
  movedCounties(event) {
    ...
    if (!county) {
      this.activeCounty = null;
      this.activePath.attr("d", null);
      this.tooltip.hide();
    } else if (this.activeCounty !== county) {
      this.activeCounty = county;
      this.activePath.attr("d", this.geoPath(county));
  ...
  leftState(event, d) {
    this.statePath.classed("is-active", false).order();
