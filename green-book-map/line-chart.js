...
import { valueFormat } from "./constants.js";
...
export default class LineChart {
  ...
  renderXAxis() {
    this.gX
      ...
      .call(d3.axisBottom(this.x).ticks(5, "d").tickSizeOuter(0).tickPadding(4))
      .attr("font-size", null)
      .attr("font-family", null);
  }

  renderYAxis() {
    const tickValues = this.y.ticks(4).filter((d) => d % 1 === 0);
    ...
    this.gY
      ...
      .call((g) =>
        g
          ...
          .text("Number of Green Book Locations")
      );
  }
  ...
  updateData(data) {
    ...
    this.data = data;
    this.y.domain([0, d3.max(data.values()) || 1]).nice();
    this.renderYAxis();
    this.renderPath();
    this.renderCircles();
    this.renderFocus();
